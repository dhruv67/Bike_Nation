...
@section('usercontent')
    <div class="woocommerce">
        <div class="container">
            ...
            <form name="billing_checkout" id="billing_checkout" method="POST"
                class="checkout woocommerce-checkout form-in-checkout" action="/addbilling">
                @csrf
                <ul class="row">
                    <li class="col-md-9">
                    ...
                    @if (!empty($address))
                        @foreach ($address as $items)
                            <li class="col-md-9">
                                <input type="radio" name="address" value="{{ $items->id }}" class="rba" checked><label>Address:&nbsp;
                                </label>{{ $items->address }}
                            </li>
                                ...
                                <ul class="row">
                                    <li class="col-md-6">
                                        <p class="form-row validate-required" id="billing_first_name_field">
                                            ...
                                            <input type="text" class="input-text " name="billing_first_name"
                                                id="billing_first_name" placeholder="" value="" required>
                                    ...
                                    <li class="col-md-6">
                                        <p class="form-row validate-required" id="billing_last_name_field">
                                            ...
                                            <input type="text" class="input-text " name="billing_last_name"
                                                id="billing_last_name" placeholder="" value="" required>
                                    ...
                                    <li class="col-md-12  col-left-12">
                                        <p class="form-row  validate-required validate-email" id="billing_email_field">
                                            ...
                                            <input type="text" class="input-text " name="billing_email"
                                                id="billing_email" placeholder="" value="" required>
                                    ...
                                    <li class="col-md-6">
                                        <p class="form-row address-field validate-postcode woocommerce-validated"
                                            ...
                                            <input type="text" class="input-text " name="billing_pincode"
                                                id="billing_pincode" value="" required>
                                    ...
                                    <li class="col-md-6">
                                        <p class="form-row validate-required validate-phone woocommerce-validated"
                                            ...
                                            <input type="text" class="input-text" name="billing_phone"
                                                id="billing_phone" placeholder="" value="" required>
                                    ...
                                    <li class="col-md-12  col-left-12">
                                        <p class="form-row  validate-required validate-email" id="#">
                                            ...
                                            <textarea name="billing_address" cols="116" rows="4" id="billing_address" required></textarea>
                ...
                <div class="checkout-col-footer">
                    <li class="col-md-12 col-left-12 form-radios">
                        <span class="form-radio"><input type="radio" name="shipping" id="rs1" value="ship_same"
                                checked><label for="rs1">Ship to this address</label></span>
                        <span class="form-radio"><input type="radio" name="shipping" id="rs2"
                                value="ship_diff"><label for="rs2">Ship to different address</label></span>
                    </li>
    ...
    @section('userscripts')
        <script>
            ...
            $("#billing_first_name").attr("maxlength", "46");
            $("#fname_err").hide();
            ...
            $("#billing_lirst_name").attr("maxlength", "46");
            $("#lname_err").hide();
            ...
            $("#billing_pincode").attr("maxlength", "6");
            $("#pincode_err").hide();
            $("#billing_pincode").keypress(function(e) {
                var kk = e.which;
                if (kk < 48 || kk > 57) {
                    e.preventDefault();
                    $("#pincode_err").show();
            ...
            $("#billing_city").attr("maxlength", "35");
            $("#city_err").hide();
            ...
            $("#billing_state").attr("maxlength", "45");
            $("#city_err").hide();
            $("#billing_state").keypress(function(e) {
                var keyCode = e.keyCode || e.which;
                $("#state_err").html("");
                //Regex for Valid Characters i.e. Alphabets.
                var regex = /^[\s+A-Za-z]+$/;
            ...
            $("#billing_country").attr("maxlength", "56");
            $("#country_err").hide();
            $("#billing_country").keypress(function(e) {
                var keyCode = e.keyCode || e.which;
                $("#country_err").html("");
                //Regex for Valid Characters i.e. Alphabets.
                var regex = /^[\s+A-Za-z]+$/;
            ...
            $("#billing_address").attr("maxlength", "56");
            // $("#address_err").hide();
            ...
            $("#billing_email").attr("maxlength", "62");
            $( "#billing_checkout" ).validate({
                rules: {
                    billing_email: {
                    required: true,
                    email: true
